...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-07-2019 a las 07:20:13
...
(1, 1, 1, '10.00', 1, 13.00, 5.00, 0, 'EPSON TM-U220 Receipt', 'WorkCentre 6605DN-55CBD6 PS', 'Microsoft Print to PDF', 1, 0, 1);
...
(3, 'Pagos Mixtos(Efectivo + Tarjeta de CrÃƒÂ©dito', '55251515', '0.00');
...
(3, 2, 1, 1, '2019-06-07 23:00:06', 'ADELANTO DANIEL', '15.20'),
(4, NULL, 1, 1, '2019-06-09 10:53:11', 'SOLICITADO POR GABIREL', '5.00'),
(5, NULL, 1, 1, '2019-06-15 10:09:02', 'COMPRA DE VASOS DESECHABLES', '2.00'),
(6, NULL, 1, 1, '2019-06-15 10:09:50', 'RECIBO DE AGUA JUNIO', '6.00');
...
(30, 'Josseline', 'GÃƒÂ³mez', '', '', '70707070', '', '', '0.00', '0.00'),
...
--
-- Estructura de tabla para la tabla `logfile`
--
...
--
-- Volcado de datos para la tabla `logfile`
--
...
(4, 2990, 1, '2019-04-14 19:05:53', 'Inicio de sesiÃƒÂ³n', 'Satisfactorio'),
(5, 2990, 1, '2019-04-14 19:06:10', 'Ingreso a la administraciÃƒÂ³n de cuentas', 'Satisfactorio'),
...
(10, 2990, 1, '2019-04-14 19:08:20', 'Cierre de sesiÃƒÂ³n', 'Satisfactorio'),
(11, 2991, 1, '2019-04-16 13:54:30', 'Inicio de sesiÃƒÂ³n', 'Satisfactorio'),
...
(20, 2992, 1, '2019-04-16 23:56:05', 'Inicio de sesiÃƒÂ³n', 'Satisfactorio'),
(21, 2992, 1, '2019-04-16 23:56:08', 'Ingreso a TPV', 'Satisfactorio'),
(22, 2992, 1, '2019-04-16 23:57:57', 'Cierre de sesiÃƒÂ³n', 'Satisfactorio'),
(23, 2993, 1, '2019-04-17 10:09:16', 'Inicio de sesiÃƒÂ³n', 'Satisfactorio'),
...
(26, 2994, 1, '2019-04-17 10:20:53', 'Inicio de sesiÃƒÂ³n', 'Satisfactorio'),
...
(33, 2988, 1, '2019-04-17 10:59:52', 'Cierre de sesiÃ³n', 'Satisfactorio'),
(34, 2995, 1, '2019-05-26 18:09:05', 'Inicio de sesiÃ³n', 'Satisfactorio'),
(35, 2995, 1, '2019-05-26 18:09:16', 'Apertura de caja', 'Satisfactorio'),
(36, 2995, 1, '2019-05-26 18:11:18', 'Cierre de sesiÃ³n', 'Satisfactorio'),
(37, 2996, 1, '2019-05-26 19:35:58', 'Inicio de sesiÃ³n', 'Satisfactorio'),
(38, 2996, 1, '2019-05-26 19:36:02', 'Cierre de sesiÃ³n', 'Satisfactorio'),
(39, 2997, 1, '2019-06-09 11:35:08', 'Inicio de sesiÃ³n', 'Satisfactorio'),
(40, 2997, 1, '2019-06-09 11:35:14', 'Cierre de sesiÃ³n', 'Satisfactorio'),
(41, 2998, 1, '2019-06-09 11:36:09', 'Inicio de sesiÃ³n', 'Satisfactorio'),
(42, 2998, 1, '2019-06-09 11:36:12', 'Cierre de sesiÃ³n', 'Satisfactorio'),
(43, 2999, 1, '2019-06-15 10:25:55', 'Inicio de sesiÃ³n', 'Satisfactorio'),
(44, 2999, 1, '2019-06-15 10:26:00', 'Ingreso a Datos de la Empresa', 'Satisfactorio'),
(45, 2999, 1, '2019-06-15 10:26:32', 'Cierre de sesiÃ³n', 'Satisfactorio');
...
--
-- Estructura de tabla para la tabla `pago_mixto`
--
...
(13, 29, 1, 'PESCADO PEQUEÃƒâ€˜O', 'PESCADO PEQUEÃƒâ€˜O', '5.99', '0.00', 'thA3FONYEV.jpg', 1, 0, -12, 0, 1),
...
(30, 33, 1, 'ENSALADA FRESCA CON ATUN', 'ENSALADA FRESCA CON ATUN', '6.99', '0.00', 'Ensalada-con-atÃƒÂºn.jpg', 0, 0, -2, 0, 1),
...
(36, 34, 1, 'QUESADILLA', 'QUESADILLA', '2.49', '0.00', 'quesadilla-salvadoreÃƒÂ±a-receta.jpg', 1, 0, -209, 0, 1),
...
(109, 47, 1, 'PLATO DE BOCA PEQUEÃƒâ€˜O', '', '5.00', '0.00', 'atun1.jpg', 0, 0, -22, 0, 1),
...
(144, 51, 1, 'TARTA DE ATÃƒÅ¡N', '', '2.90', '0.00', 'Tarta de atÃƒÂºn.jpg', 0, 0, 0, 0, 1),
...
--
-- Estructura de tabla para la tabla `tiraje_factura`
--

CREATE TABLE `tiraje_factura` (
  `idTiraje` int(5) NOT NULL,
  `tipoFactura` enum('CONSUMIDOR FINAL','CRÃƒâ€°DITO FISCAL') NOT NULL,
...
--
-- Volcado de datos para la tabla `tiraje_factura`
--
...
ALTER TABLE `ajuste_stock`
  ...
  ADD KEY `idx_ajuste_producto` (`idProducto`),
  ADD KEY `idx_ajuste_ingrediente` (`idIngrediente`) USING BTREE,
  ADD KEY `idx_ajuste_usuario` (`idUsuario`) USING BTREE;
...
ALTER TABLE `caja`
  ...
  ADD KEY `FK_idCajero1_idx` (`idCajero`);
...
ALTER TABLE `cocinero`
  ...
  ADD KEY `fk_cocinero_empleado1_idx` (`idEmpleado`);

--
-- Indices de la tabla `comando`
--
ALTER TABLE `comando`
  ADD PRIMARY KEY (`idComando`);
...
ALTER TABLE `compra`
  ...
  ADD KEY `fk_pedido_mesero1_idx` (`idUsuario`),
  ADD KEY `fk_pedido_proveedor1_idx` (`idProveedor`),
  ADD KEY `fk_compra_comprobante_1_idx` (`idComprobante`);
...
ALTER TABLE `egreso`
  ...
  ADD KEY `FK_idCaja2_idx` (`idCaja`),
  ADD KEY `Fk_usr_egreso` (`idUsuario`) USING BTREE,
  ADD KEY `Fk_egreso_tipo` (`idEgresoTipo`) USING BTREE;
...
ALTER TABLE `ingrediente`
  ...
  ADD KEY `FK_unidad2_idx` (`idUnidad`);
...
ALTER TABLE `ingrediente_producto`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idProducto_dx` (`idProducto`),
  ADD KEY `idIngrediente_dx` (`idIngrediente`);

--
-- Indices de la tabla `logfile`
--
ALTER TABLE `logfile`
  ADD PRIMARY KEY (`idLog`),
  ADD KEY `usuarioLod_idx` (`idUsuario`),
  ADD KEY `usuarioSesio_idx` (`idSesion`);
...
ALTER TABLE `mesa`
  ...
  ADD KEY `FKSalon1_idx` (`idSalon`);

--
-- Indices de la tabla `pago_mixto`
--
ALTER TABLE `pago_mixto`
  ADD PRIMARY KEY (`idPago`),
  ADD KEY `idPedido_5idx` (`idPedido`),
  ADD KEY `idTarjeta_1idx` (`idTarjeta`);
...
ALTER TABLE `pedido`
  ...
  ADD KEY `fk_pedido_cuenta1_idx` (`idCuenta`),
  ADD KEY `fk_pedido_cliente1_idx` (`idCliente`),
  ADD KEY `fk_pedido_mesero1_idx` (`idMesero`) USING BTREE,
  ADD KEY `fk_tiraje_factura` (`idTiraje`);
...
ALTER TABLE `pedido_detalle`
  ...
  ADD KEY `FK8EC261C66039B36F_idx` (`idProducto`),
  ADD KEY `FK8EC261C6B9DECED7_idx` (`idCocinero`),
  ADD KEY `fk_pedido_detalle_pedido1_idx` (`idPedido`);

--
-- Indices de la tabla `permiso`
--
ALTER TABLE `permiso`
  ADD KEY `FK9481C4FEC6F99584_idx` (`idRol`),
  ADD KEY `FK9481C4FEC6F99121_idx` (`idComando`);
...
ALTER TABLE `producto`
  ...
  ADD KEY `fk_plato_tipoplato1_idx` (`idFamilia`),
  ADD KEY `fk_unidadMedida_idx` (`idUnidad`);
...
ALTER TABLE `sesion`
  ...
  ADD KEY `idUsuario_dx` (`idUsuario`);
...
--
-- Indices de la tabla `tiraje_factura`
--
ALTER TABLE `tiraje_factura`
...
ALTER TABLE `usuario`
  ...
  ADD UNIQUE KEY `fk_empl_usr` (`idUsuario`),
  ADD KEY `fk_rol_usr_1` (`idRol`);
...
--
ALTER TABLE `cocinero`
  MODIFY `idCocinero` int(3) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `comando`
--
ALTER TABLE `comando`
  MODIFY `idComando` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
--
...
--
ALTER TABLE `comprobante`
  MODIFY `idComprobante` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de la tabla `configuracion`
--
ALTER TABLE `configuracion`
  MODIFY `idConfiguracion` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `cuenta`
--
ALTER TABLE `cuenta`
  MODIFY `idCuenta` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de la tabla `egreso`
--
ALTER TABLE `egreso`
  MODIFY `idEgreso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT de la tabla `empleado`
--
ALTER TABLE `empleado`
  MODIFY `idEmpleado` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
--
...
--
ALTER TABLE `familia`
  MODIFY `idFamilia` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
--
-- AUTO_INCREMENT de la tabla `ingrediente`
--
ALTER TABLE `ingrediente`
  MODIFY `idIngrediente` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
-- AUTO_INCREMENT de la tabla `logfile`
--
ALTER TABLE `logfile`
...
--
ALTER TABLE `proveedor`
  MODIFY `idProveedor` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `salon`
  MODIFY `idSalon` int(2) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `sesion`
--
ALTER TABLE `sesion`
  MODIFY `idSesion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3000;
--
-- AUTO_INCREMENT de la tabla `tarjeta_credito`
--
ALTER TABLE `tarjeta_credito`
  MODIFY `idTarjeta` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de la tabla `ticket`
--
ALTER TABLE `ticket`
  MODIFY `idTicket` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `tiraje_factura`
--
ALTER TABLE `tiraje_factura`
  MODIFY `idTiraje` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `unidadmedida`
--
ALTER TABLE `unidadmedida`
  MODIFY `idUnidad` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
...
--
ALTER TABLE `ajuste_stock`
  ADD CONSTRAINT `fk_ajusteStock_ingrediente` FOREIGN KEY (`idIngrediente`) REFERENCES `ingrediente` (`idIngrediente`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_ajusteStock_producto` FOREIGN KEY (`idProducto`) REFERENCES `producto` (`idProducto`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_ajusteStock_usuario` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`idUsuario`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `caja`
--
ALTER TABLE `caja`
  ADD CONSTRAINT `FK_idCajero1` FOREIGN KEY (`idCajero`) REFERENCES `usuario` (`idUsuario`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `cocinero`
--
ALTER TABLE `cocinero`
  ADD CONSTRAINT `fk_cocinero_empleado1` FOREIGN KEY (`idEmpleado`) REFERENCES `empleado` (`idEmpleado`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `compra`
--
ALTER TABLE `compra`
  ADD CONSTRAINT `fk_compra_comprobante_1` FOREIGN KEY (`idComprobante`) REFERENCES `comprobante` (`idComprobante`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `compra_detalle`
  ADD CONSTRAINT `fk_detalle_compra` FOREIGN KEY (`idCompra`) REFERENCES `compra` (`idCompra`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_detalle_ingrediente` FOREIGN KEY (`idIngrediente`) REFERENCES `ingrediente` (`idIngrediente`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_detalle_producto` FOREIGN KEY (`idProducto`) REFERENCES `producto` (`idProducto`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `egreso`
--
ALTER TABLE `egreso`
  ADD CONSTRAINT `FK_idCaja2` FOREIGN KEY (`idCaja`) REFERENCES `caja` (`idCaja`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `Fk_usr_egreso` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`idUsuario`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `ingrediente`
--
ALTER TABLE `ingrediente`
  ADD CONSTRAINT `FK_unidad2` FOREIGN KEY (`idUnidad`) REFERENCES `unidadmedida` (`idUnidad`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `ingrediente_producto`
--
ALTER TABLE `ingrediente_producto`
  ADD CONSTRAINT `ingrediente_producto_ibfk_1` FOREIGN KEY (`idIngrediente`) REFERENCES `ingrediente` (`idIngrediente`) ON UPDATE CASCADE,
  ADD CONSTRAINT `ingrediente_producto_ibfk_2` FOREIGN KEY (`idProducto`) REFERENCES `producto` (`idProducto`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `logfile`
--
ALTER TABLE `logfile`
  ADD CONSTRAINT `FK_logUsuario` FOREIGN KEY (`idUsuario`) REFERENCES `empleado` (`idEmpleado`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_sesionUsuario` FOREIGN KEY (`idSesion`) REFERENCES `sesion` (`idSesion`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `mesa`
--
ALTER TABLE `mesa`
  ADD CONSTRAINT `FKSalon1` FOREIGN KEY (`idSalon`) REFERENCES `salon` (`idSalon`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `pago_mixto`
--
ALTER TABLE `pago_mixto`
  ADD CONSTRAINT `idPedido_fk_5idx` FOREIGN KEY (`idPedido`) REFERENCES `pedido` (`idPedido`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `idTarjeta_fk_1idx` FOREIGN KEY (`idTarjeta`) REFERENCES `tarjeta_credito` (`idTarjeta`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `pedido`
--
ALTER TABLE `pedido`
  ADD CONSTRAINT `fk_pedido_cliente1` FOREIGN KEY (`idCliente`) REFERENCES `cliente` (`idCliente`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_pedido_cuenta1` FOREIGN KEY (`idCuenta`) REFERENCES `cuenta` (`idCuenta`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_pedido_mesa11` FOREIGN KEY (`idMesa`) REFERENCES `mesa` (`idMesa`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `pedido_ibfk_1` FOREIGN KEY (`idMesero`) REFERENCES `usuario` (`idUsuario`) ON DELETE SET NULL ON UPDATE NO ACTION,
  ADD CONSTRAINT `pedido_ibfk_2` FOREIGN KEY (`idTiraje`) REFERENCES `tiraje_factura` (`idTiraje`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `pedido_detalle`
--
ALTER TABLE `pedido_detalle`
  ADD CONSTRAINT `FK8EC261C66039B36F` FOREIGN KEY (`idProducto`) REFERENCES `producto` (`idProducto`),
  ADD CONSTRAINT `FK8EC261C6B9DECED7` FOREIGN KEY (`idCocinero`) REFERENCES `cocinero` (`idCocinero`),
  ADD CONSTRAINT `fk_pedido_detalle_pedido1` FOREIGN KEY (`idPedido`) REFERENCES `pedido` (`idPedido`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `permiso`
--
ALTER TABLE `permiso`
  ADD CONSTRAINT `FK9481C4FEC6F99121` FOREIGN KEY (`idComando`) REFERENCES `comando` (`idComando`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `FK9481C4FEC6F99584` FOREIGN KEY (`idRol`) REFERENCES `rol` (`idRol`);

--
-- Filtros para la tabla `producto`
--
ALTER TABLE `producto`
  ADD CONSTRAINT `fk_familia1` FOREIGN KEY (`idFamilia`) REFERENCES `familia` (`idFamilia`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_unidadMedida1` FOREIGN KEY (`idUnidad`) REFERENCES `unidadmedida` (`idUnidad`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `sesion`
  ADD CONSTRAINT `sesionUsuario_FK` FOREIGN KEY (`idUsuario`) REFERENCES `empleado` (`idEmpleado`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `usuario`
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `fk_empl_usr` FOREIGN KEY (`idUsuario`) REFERENCES `empleado` (`idEmpleado`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_rol_usr_1` FOREIGN KEY (`idRol`) REFERENCES `rol` (`idRol`) ON UPDATE CASCADE;
